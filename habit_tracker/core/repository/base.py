...
class BaseRepository(Generic[ModelType]):
    ...
    async def create(self, attributes: dict[str, Any] = None) -> ModelType:
        """
        Creates the schemas instance.

        :param attributes: The attributes to create the schemas with.
        :return: The created schemas instance.
        """
    ...
    async def get_all(
        ...
        """
        Returns a list of schemas instances.

        :param skip: The number of records to skip.
        :param limit: The number of record to return.
        :param join_: The joins to make.
        :return: A list of schemas instances.
        """
    ...
    async def get_by(
        ...
        """
        Returns the schemas instance matching the field and value.

        :param field: The field to match.
        :param value: The value to match.
        :param join_: The joins to make.
        :return: The schemas instance.
        """
        query = self._query(join_)
    ...
    async def delete(self, model: ModelType) -> None:
        ...
        :param model: The schemas to delete.
        :return: None
        """
    ...
    def _query(
        ...
        """
        Returns a callable that can be used to query the schemas.

        :param join_: The joins to make.
        :param order_: The order of the results. (e.g desc, asc)
        :return: A callable that can be used to query the schemas.
        """
    ...
    async def _first(self, query: Select) -> ModelType | None:
        ...
        :param query: The query to execute.
        :return: The first schemas instance.
        """
        query = await self.session.scalars(query)
        return query.first()
    ...
    async def _sort_by(
        ...
        :param model: The schemas to sort.
